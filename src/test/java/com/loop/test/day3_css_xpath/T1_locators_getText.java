...
public class T1_locators_getText {
    public static void main(String[] args) {
        ...
        driver.get("https://beta.docuport.app");//get method

        WebElement userName= driver.findElement(By.id("input-14"));//webElement(interface)
        userName.sendKeys(DocuportConstants.USERNAME_CLIENT);//clean code,change edende edir o birilerin)

        WebElement LoginButton = driver.findElement(By.className("v-btn__content"));
        LoginButton.click(); //(it comes selenium package)
