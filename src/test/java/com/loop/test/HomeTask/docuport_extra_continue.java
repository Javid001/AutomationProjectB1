...
public class docuport_extra_continue extends TestBase {
    @Test
    public void test() throws InterruptedException {
        ...
        String expectedMessage = "You have exceeded the maximum number of declines on this card in the last 24 hour period. Please contact us via https://support.stripe.com/contact if you need further assistance.";
